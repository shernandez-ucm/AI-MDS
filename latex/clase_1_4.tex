...
\begin{tikzpicture}[font=\scriptsize,
	...
	\node[rectangle, rounded corners=3pt, draw=AccentGreen!60!black, thick,
		...
		(c) at (3.3,-2.1)
		{\textbf{Y sin embargo, funciona.}\\
		 \emph{O los datos, o los modelos, o los algoritmos ---}\\
		 \emph{o los tres --- tienen alguna propiedad especial.}};
...
\end{itemize}
\vspace{0.2em}
\idea{El t\'itulo del libro de Prince es \emph{Understanding Deep Learning}; el propio autor advierte que es en parte una broma, porque nadie entiende del todo por qu\'e esto funciona.}
\end{frame}
...
\begin{frame}
\frametitle{Sobreparametrización: un pajar de agujas}
\footnotesize % ajuste de densidad
\begin{columns}[T]
\begin{column}{6.4cm}
\begin{itemize}
...
\begin{frame}
\frametitle{Curvatura: puntos silla y la zona Ricitos de Oro}
\footnotesize % ajuste de densidad
\begin{columns}[c]
\begin{column}{6.1cm}
\begin{center}
...
\begin{frame}
\frametitle{La norma de los pesos y el \emph{grokking}}
\footnotesize % ajuste de densidad
\begin{columns}[c]
\begin{column}{6.2cm}
\begin{center}
